...
classementContreLaMontre = SauvegardeClassementContreLaMontre.new
profil = Profil.new("Léo")
score1 = Score.new(40, profil)


classementContreLaMontre.ajoutScore(score1)

classementContreLaMontre.afficheToi()
