...
class FenetreMenu < Fenetre
    ...
    def gestionSignaux
        ...
        @btn_aventure.signal_connect('clicked') {print "\ntu as clique sur le mode Aventure\n"}

        @btn_tuto.signal_connect('clicked') {
            print "tu as clique sur le mode tuto\n"}

        @btn_propos.signal_connect('clicked') {
            print "\ntu as clique sur a propos\n"
